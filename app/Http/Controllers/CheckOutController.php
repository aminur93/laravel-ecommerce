...
class CheckOutController extends Controller
{
    ...
    public function customer_login(Request $request)
    {
        ...
        if ($result)
        {
            ...
            Session::put('message','Email And Password Is Invalid');
    ...
    public function order_place(Request $request)
    {
      ...
      $order_id = DB::table('tbl_order')->insertGetId($odata);
        ...
        elseif ($payment_gatway == 'debitcart'){
            echo "Successfully Done by debitcart";
        }
        elseif ($payment_gatway == 'bekash')
        {
            echo "Successfully Done by Bekash";
        }
        elseif ($payment_gatway == 'payza')
        {
    ...
    public function unactive_order($order_id)
    {
        DB::table('tbl_order')
            ->where('order_id',$order_id)
            ->update(['order_status' => 'panding']);
        Session::put('message','Order panding Successfully');
        return Redirect::to('/manage-order');
    }
    ...
    public function active_order($order_id)
    {
        ...
        Session::put('message','Order Shipped Successfully');
        return Redirect::to('/manage-order');
    }
}
