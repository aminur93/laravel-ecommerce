        ...
        <div class="product-details"><!--product-details-->
            ...
            <div class="col-sm-7">
                <div class="product-information"><!--/product-information-->
                    ...
                    <p>Category : {{$product_by_details->category_name}}</p>
                    <img src="{{asset('user/images/product-details/rating.png')}}" alt="" />
                    <span>
        ...
        <div class="category-tab shop-details-tab"><!--category-tab-->
            ...
            <div class="tab-content">
                <div class="tab-pane fade" id="details" >
                    <p style="margin: 0 20px 0 20px;">{{$product_by_details->product_long_description}}</p>
                </div>
                ...
                <div class="tab-pane fade active in" id="reviews" >
                    <div class="col-sm-12">
                        ...
                        <form action="#">
                            ...
                            <b>Rating: </b> <img src="{{asset('user/images/product-details/rating.pngphp')}}" alt="" />
