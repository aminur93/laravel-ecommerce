...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{URL::to('user/images/ico/apple-touch-icon-144-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{URL::to('user/images/ico/apple-touch-icon-114-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{URL::to('user/images/ico/apple-touch-icon-72-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" href="{{URL::to('user/images/ico/apple-touch-icon-57-precomposed.png')}}">
    <style>
        .paymentWrap {
            padding: 50px;
        }
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="{{URL::to('/')}}"><img src="{{asset('user/images/home/logo.png')}}" alt="" /></a>
                    </div>
                </div>
                <div class="col-sm-8">
                    ...
                    <div class="brands_products"><!--brands_products-->
                        ...
                        <div class="brands-name">
                            <ul class="nav nav-pills nav-stacked">
                                <?php
                                $all_brand_publish = DB::table('manufacture')
                                    ->where('publication_status',1)
                                    ->get();
                                foreach ($all_brand_publish as $brand){
                                ?>
                                <li><a href="{{URL::to('/product_by_manufacture/'.$brand->manufacture_id)}}"> <span class="pull-right">()</span>{{$brand->manufacture_name}}</a></li>
                                    <?php }?>
                            </ul>
                        </div>
                    </div><!--/brands_products-->
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                ...
                <p class="pull-right">Develop by <span><a target="_blank" href="">Aminur Rashid</a></span></p>
            </div>
        </div>
    </div>
